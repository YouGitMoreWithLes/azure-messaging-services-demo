...
namespace ServiceBusConsumer
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            try
            {
                Console.WriteLine("Starting Service Bus Topic Consumer...");
                Console.WriteLine($"Application Path: {Assembly.GetExecutingAssembly().Location}");
                ...
                string topicName = Environment.GetEnvironmentVariable("SERVICE_BUS_TOPIC_NAME") ?? "example-topic";

                // name of your Service Bus topic subscription
                string topicSubscriptionName = Environment.GetEnvironmentVariable("SERVICE_BUS_TOPIC_NAME") ?? "example-topic-subscription2";
                ...
                processor = client.CreateProcessor(topicName, topicSubscriptionName, new ServiceBusProcessorOptions
                {
